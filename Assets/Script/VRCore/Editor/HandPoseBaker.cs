...
namespace VRCore.Editor
{
    public class HandPoseBaker : EditorWindow
    {
        ...
        [MenuItem("VRCore/Hand Pose Baker", priority = 22)]
        ...
        private void DrawPoseSaveSection()
        {
            ...
            if (GUILayout.Button("Save Open Pose"))
            {
                ...
                Debug.Log("[VRCore] Open pose saved to FingerRig.");
            }

            if (GUILayout.Button("Save Closed Pose"))
            {
                _targetRig.SaveClosedPose();
                Debug.Log("[VRCore] Closed pose saved to FingerRig.");
            }
        ...
        private void DrawPoseLoadSection()
        {
            ...
            _currentPose = (HandPoseData)EditorGUILayout.ObjectField("Pose Asset", _currentPose,
                typeof(HandPoseData), false);
        ...
        private void BakeCurrentPose()
        {
            ...
            _currentPose = pose;
            Debug.Log($"[VRCore] Hand pose saved to {path}");
        }
        ...
        private void CreateFingerRigFromDetection(Transform handRoot)
        {
            ...
            {
                Debug.LogWarning("[VRCore] No fingers detected.");
                return;
            }
            ...
            _targetRig = rig;
            Debug.Log($"[VRCore] FingerRig created with {detected.Length} detected finger chains.");
        }
    }
}
#endif
